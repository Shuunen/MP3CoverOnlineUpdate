...
namespace Mp3AlbumCoverUpdater
{
	public partial class frmMp3Album : Form
	{
		...
		private void GetFiles(object sender, EventArgs e)
		{
			...
			var dc1 = new DataColumn("标题", typeof(string));
			var dc2 = new DataColumn("路径", typeof(string));
			var dc3 = new DataColumn("专辑封面", typeof(Image));
		...
		private void dgvList_SelectionChanged(object sender, EventArgs e)
		{
			...
			try {
				...
				var mp3fileinfo = new Mp3FileInfo(dgvList.SelectedRows[0].Cells["路径"].Value.ToString());
